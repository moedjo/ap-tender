...
class ThemeSync extends Command
{
    ...
    {
        return $this->error("This command has been disabled. Please contact support");
        ...
        if (!Theme::databaseLayerEnabled()) {
            return $this->error("cms.database_templates is not enabled, enable it first and try again.");
        }
